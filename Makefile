...
OFILES = gba.o font.o logic.o graphics.o main.o images/snake1.o images/grass.o images/gameOver.o images/mushroom.o images/skin.o images/sand.o images/garbage.o
